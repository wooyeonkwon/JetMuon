...
from root_tool import Profile1D_filtery_def_test
...
######################################################################################
# Usage of this code                                                                 #
# python3 script.py <path/to/data.root> <path/to/config.json> [path/to/output/folder]#
######################################################################################


if len(sys.argv) > 2:
    root_path = sys.argv[1]
    if not root_path.endswith('.root'):
        print("Error: The file is not a ROOT file.")
        print("Usage: script.py <path/to/data.root> <path/to/config.json> [path/to/output/folder]")
        sys.exit(1)
...
def draw_histogram(root_rdf, tree_name, branch, output_dir="."):
    ...
    hist_root = Profile1D_filtery_def(root_rdf, branch, True)
